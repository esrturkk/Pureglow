...
const questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            {
                text: "Nadiren nemlendirici kullanırım",
...
const showAnswer = () => {
    const counts = [0, 0, 0, 0]; // Yağlı, Karma, Kuru, Hassas cilt cevaplarının sayısını saklayacak dizi
...
const showLink = (mostSelectedAnswer) => {
    ...
    document.getElementById('hassas').style.display = 'none';
     ...
     } else if (mostSelectedAnswer === 'Hassas Cilt') {
         document.getElementById('hassas').style.display = 'block';
     }
}
